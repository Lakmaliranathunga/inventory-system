...
Public registration is disabled; Admin Officers create accounts through `/api/users`. Roles 1, 2, 3, and 4 can change operational data. Only Admin Officers can manage users.
